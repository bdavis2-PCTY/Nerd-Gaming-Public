...
function attemptLogin ( user, pass )
	if ( user and pass and type ( user ) == 'string' and type ( pass ) == 'string' ) then
		...
		if ( account ) then
			...
			exports['NGLogs']:outputActionLog ( getPlayerName ( source ).." has logged in" )
...
function triggerLogin ( source, user,  pass, triggerIntro ) triggerClientEvent ( source, "onClientPlayerLogin", source, user, pass, triggerIntro ) end
