...
function readScoreboardSettings()
	...
	if not settingsFile then
		...
		local useanimationTag = xmlCreateChild( settingsFile, "useanimation" )
			xmlNodeSetValue( useanimationTag, "false" )
	...
	cScoreboardBackground = tocolor( 0,0,0,100 )
	...
	cHighlight = tocolor( 255,133,0,50 )
	cHeader = tocolor( 255,133,0, 255)
	...
	cServerInfo = tocolor( 255,133,0, 255)
