	...
	if #scoreboardColumns ~= 0 then
		...
		if scoreboardDrawn then
			...
			if serverInfo.server and showServerInfo then
				dxDrawText( serverInfo.server, topX+s(5)+s(1), y+s(1), topX+scoreboardDimensions.width-s(10), y+dxGetFontHeight( fontscale(serverInfoFont, scoreboardScale), serverInfoFont ), tocolor(0,0,0,190), fontscale(serverInfoFont, s(1)), serverInfoFont, "left", "top", false, false, drawOverGUI )
				dxDrawText( serverInfo.server, topX+s(5), y, topX+scoreboardDimensions.width-s(10), y+dxGetFontHeight( fontscale(serverInfoFont, scoreboardScale), serverInfoFont ), cServerInfo, fontscale(serverInfoFont, s(1)), serverInfoFont, "left", "top", false, false, drawOverGUI )
			end
			if showServerInfo and serverInfo.players then
				...
				dxDrawText( text, topX+scoreboardDimensions.width-s(5)-textWidth, y, topX+scoreboardDimensions.width-s(5), y+dxGetFontHeight( fontscale(serverInfoFont, scoreboardScale), serverInfoFont ), cServerInfo, fontscale(serverInfoFont, s(1)), serverInfoFont, "left", "top", false, false, drawOverGUI )
			end
			...
			for key, column in ipairs( scoreboardColumns ) do
				...
				if sortBy.what == column.name then
					...
					dxDrawText( column.friendlyName or "-", topX+x+s(9), 	y, 	topX+x+s(column.width), 	y+dxGetFontHeight( fontscale(columnFont, scoreboardScale), columnFont ), cHeader, fontscale(columnFont, s(0.8)), columnFont, "left", "top", true, false, drawOverGUI )
					...
					dxDrawText( column.friendlyName or "-", topX+x, 	y, 	topX+x+s(column.width), 	y+dxGetFontHeight( fontscale(columnFont, scoreboardScale), columnFont ), cHeader, fontscale(columnFont, s(0.9)), columnFont, "left", "top", true, false, drawOverGUI )
				end
...
fileDelete("dxscoreboard_client.lua")