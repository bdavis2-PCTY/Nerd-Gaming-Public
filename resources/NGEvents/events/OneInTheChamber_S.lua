events[2] = { 
	...
	warpPoses = {									-- Positions players will warp to on start
		-- { x, y, z, rot },
		{ -1254.05, 491.64, 16.58, 180 },			-- Warp position 1
		{  -1459.74, 513.38, 3.04, -70 },			-- Warp position 1
		{ -1415.63, 506.25, 3.04, 180 },			-- Warp position 1
		{ -1384.37, 507.69, 3.04, -90 },			-- Warp position 1
		{ -1369.13, 495.68, 3.04, 100 },			-- Warp position 1
		{ -1351.86, 494.52, 11.2, 100 },			-- Warp position 1
		{ -1395.21, 495.9, 19.5, 0 },				-- Warp position 1
		{ -1319, 492.66, 18.23, -90 },				-- Warp position 1
		{ -1324.92, 486.97, 11.19, 180 },			-- Warp position 1
		{ -1290.35, 491.52, 11.2, 90 },				-- Warp position 1
		{ -1362.64, 502.71, 11.2, -90 },			-- Warp position 1
		{ -1394.38, 499.66, 11.2, 0 },				-- Warp position 1
	},
